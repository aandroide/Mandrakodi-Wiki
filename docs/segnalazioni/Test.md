...
container.innerHTML = `
  <a href="calendario/eventi/#live" class="cal-btn-badge cal-btn-live">
    🔴 LIVE <span class="cal-count">${totLive}</span>
  </a>
  <a href="calendario/eventi/#serie-a" class="cal-btn-badge">
    🇮🇹 Serie A <span class="cal-count">${conteggi["Serie A"]}</span>
  </a>
  <a href="calendario/eventi/#serie-b" class="cal-btn-badge">
    🇮🇹 Serie B <span class="cal-count">${conteggi["Serie B"]}</span>
  </a>
  <a href="calendario/eventi/#serie-c" class="cal-btn-badge">
