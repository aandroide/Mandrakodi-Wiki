...
def scarica_partite():
                ...
                try:
                    ...
                    for row in rows:
                        try:
                            ...
                            # Se non siamo nel blocco "Oggi", ignora la riga
                            if not is_sezione_oggi:
                                continue

                            # Cerca l'orario della partita (es. 15:00)
                            ...
                            # Scarta vecchi residui e notizie
    ...
    # Ordina in ordine cronologico per orario
