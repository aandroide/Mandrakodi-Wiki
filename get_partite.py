...
def extract_matches(page, competition_name):
    partite = []
    ...
    for row in match_containers:
        try:
            ...
            match_dt = parse_date_str(date_str + " " + time_str)
...
def parse_from_text(body_text, competition_name):
    partite = []
...
def main():
    ...
    # Salva nel percorso corretto: docs/segnalazioni/partite.json
